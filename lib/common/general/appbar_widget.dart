        ...
        children: [
          if (showMenuBar == true)
            Align(
              ...
              child: InkWell(
                child: imageAsset(
                    img: ic_menubar, height: 34, width: 34, color: white),
                onTap: () => bloc
                    .add(AnimatePageEvent(animate: !DashBoardScreen.animate)),
              ),
            ),
                  ...
                  onTap: () {
                    if (DashBoardScreen.animate != false)
                      bottomSheetWidget(
                          ...
                          bottomInfoTitle: bottmInfoTitle);
                  }),
            ),
        ],
      ),
...
bottomSheetWidget(
    {BuildContext context, String bottomInfo, String bottomInfoTitle}) {
        ...
        return Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                labels(text: bottomInfoTitle ?? '', color: green800, size: 20),
                verticalSpace(10),
                Text(
                  bottomInfo,
